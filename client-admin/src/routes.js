...
const TableList = React.lazy(() => import('./views/Table/table'));
...
const DashboardUser = React.lazy(() => import('./views/User/Auth/Dashboard'));

const routesAdmin = [
  { path: '/admin/', exact: true, name: 'Home' },
  { path: '/admin/dashboard', name: 'Dashboard', element: Dashboard },
  { path: '/admin/page', name: 'TableList', element: TableList },
  { path: '/admin/my-account', name: 'MyAccount', element: MyAccount },
]
const routerUser = [
