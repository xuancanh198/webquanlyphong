...
class ServiceService extends BaseService
{
    ...
    public function __construct(ServiceModel $model, ServiceRequest $request)
    {
        $this->model = $model;
    ...
    public function createAction()
    {
        ...
        $this->model->unit =  $this->request->unit;
        $this->model->quantity =  $this->request->quantity;
    ...
    public function updateAction($id)
    {
        ...
        $data->unit = $this->request->unit;
        $data->quantity = $this->request->quantity;
